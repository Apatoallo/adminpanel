...
class XlmDepositContent extends React.PureComponent {
  constructor(props) {
    super(props);
    this.state = {
      open: true,
      ...
      depositInfo.address_list.map(item => (
        <div className={classes.contentContainer}>
          <div className={classes.infoPaneContainer}>
            <InfoPane>
              <ul className={classes.infoPaneText}>
                <li>
                  <strong>{I18n.translate('deposit_xlm_tag_warning')}</strong>
                </li>
                <li>
                  {I18n.translate(
                    'deposit_min_label',
                    `${depositInfo.limits.deposit.min_deposit_amount} XLM`
                  )}
                </li>
              </ul>
            </InfoPane>
          ...
          <div className={classes.checkboxLine}>
            ...
            >
              {I18n.translate('deposit_show_memo_label')}
            </div>
          </div>
          {this.state.showTagChecked && (
            <div className={classes.addressContent}>
              <div className={classes.descriptionText}>
                {I18n.translate('deposit_xlm_description_text')}
              </div>
                    ...
                    data={[
                      {
                        ...
                        values: [
                          {
                            numeric: false,
                            value: I18n.translate('transfers_xlm_address_label')
                          },
                          {
                            numeric: true,
                            value: (
                      ...
                      },
                      {
                        ...
                        values: [
                          {
                            numeric: false,
                            value: I18n.translate('transfers_xlm_tag_label')
                          },
                          {
                            numeric: true,
                            value: (
...
export default withStyles(styles)(XlmDepositContent);
